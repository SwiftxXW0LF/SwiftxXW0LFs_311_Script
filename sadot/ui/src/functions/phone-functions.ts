...
const PhoneFunctions = globalThis as any as {
    components: {
    ...
    useNuiEvent: <T>(eventName: string, cb: (data: T) => void) => void
    // onNuiEvent: <T>(eventName: string, cb: (data: T) => void) => void
    formatPhoneNumber: (number: string) => string
    getSettings: () => Promise<PhoneSettings>
    onSettingsChange: (cb: (settings: PhoneSettings) => void) => void
    setApp: (app: string | { name: string; data: any }) => void
    createCall: (options: { number?: string; videoCall?: boolean; company?: string; hideNumber?: boolean }) => void
    ...
    useCamera: (cb: (url: string) => void, options: CameraComponentData) => void
    settings: PhoneSettings
    appName: string
    resourceName: string
}

export default PhoneFunctions
